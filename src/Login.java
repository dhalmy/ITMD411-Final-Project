	...
	public Login() {
		...
		btn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String query = "SELECT * FROM dhalmy_jmaners_users_final WHERE uname = ? and upass = ?;";
				try (PreparedStatement stmt = conn.getConnection().prepareStatement(query)) {
					...
					if (rs.next()) {
						...
						if (count == 3) {
							lblStatus.setText("Too many attempts. You have been locked out of further attempts.");
